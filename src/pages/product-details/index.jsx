                            ...
                            {mockRelatedProducts.map((relatedProduct) => (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="absolute top-3 right-3 z-10 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 bg-white/80 backdrop-blur-sm text-muted-foreground hover:text-error hover:bg-white"
                                    >
                                    ...
                                    <div className="p-3 flex-1 flex flex-col">
                                        ...
                                        <div className="mt-auto">
                                            <Button
                                                ...
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    const message = encodeURIComponent(`Olá ${relatedProduct.vendor}! Vi o produto "${relatedProduct.name}" no FreshLink e gostaria de saber mais informações.`);
                ...
                <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="relative w-full h-full flex items-center justify-center">
                        <button
                            ...
                            className="fixed top-6 right-6 w-12 h-12 bg-black/50 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-black/70 transition-colors duration-200 z-10"
                        >
                            <Icon name="X" size={24} />
                        </button>
                        ...
                        <div className="relative max-w-6xl max-h-[90vh] w-full h-full flex items-center justify-center">
                            ...
                            {images.length > 1 && (
                                <>
                                    <button
                                        onClick={() => setCurrentImageIndex((prev) => (prev - 1 + images.length) % images.length)}
                                        className="fixed left-6 top-1/2 -translate-y-1/2 w-16 h-16 bg-black/50 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-black/70 transition-colors duration-200"
                                    >
                                        <Icon name="ChevronLeft" size={32} />
                                    </button>
                                    <button
                                        onClick={() => setCurrentImageIndex((prev) => (prev + 1) % images.length)}
                                        className="fixed right-6 top-1/2 -translate-y-1/2 w-16 h-16 bg-black/50 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-black/70 transition-colors duration-200"
                                    >
                            ...
                            {/* Image counter */}
                            <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-black/50 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-medium">
